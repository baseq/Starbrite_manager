...
class Model_NewStoreRegister extends Model_Table
{
    ...
    protected $typeExpression = "SELECT DISTINCT(cb_type) FROM starbr_comprofiler";
    ...
    function init()
    {
        ...
        $this->addField("cb_type")->caption("Type")->type('list')->setValueList('', array($this->api->db->query($this->typeExpression)));
        ...
        $this->addField("cb_trade")->caption("Type of Trade");

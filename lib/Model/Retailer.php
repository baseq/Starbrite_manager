...
class Model_Retailer extends Model_Table {
	...
	protected $duplicateExpression = "CONCAT(cb_address1, ' ', cb_address2, ', ' , cb_city, ', ', cb_state, ', ', cb_country, ', ', cb_storeno)";
	...
	function init(){
        ...
        $this->addField("cb_notes")->visible(false)->caption("Notes")->type('text');
